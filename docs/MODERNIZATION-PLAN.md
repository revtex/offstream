...
Delivered in four PRs. **PR 1 (shell scaffold, DI, navigation, design tokens) and PR 2 (Record page) have landed;** PR 3 is the Settings and Advanced pages, PR 4 the FlaUI sweep and polish.
...
**Exit:** FlaUI suite covers every control; key-parity test passes; side-by-side behavioural review against the reference app (behaviour compared, chrome and wording deliberately not copied). **Key-parity met** in PR 1; PR 2 brings the total to 646 tests green, 73 of them in `Offstream.UI.Tests`.
