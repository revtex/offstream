...
**Still to do in this phase:** device hot-plug handling, long-path (`\\?\`) support, and VB-CABLE detection (detection only — open question 9 is unanswered, so no vendor binaries).
